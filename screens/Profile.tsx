...
import { profileScreenColor } from '../colors/Colors';
import { BottomTabParamList, RootStackParamList } from '../navigation_types/NavigationTypes';
import useLogout from '../view-models/hooks/useLogout';
import { useProfile } from '../view-models/hooks/useProfile';
...
const Profile: React.FC = (): React.JSX.Element => {
  ...
  if (loading) {
    return (
      <SafeAreaView className="bg-[#034945] flex-1 justify-center items-center">
        <ProgressBar />
      </SafeAreaView>
    );
  }
